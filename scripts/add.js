function displayDate() {
  ...
  // Change table
  const moveTR = (div) => {
    const EL_tr = div.currentTarget.closest("tr");
    // const EL_tr = div.currentTarget.closest("tr").querySelector(`[name=toDo]`);
    // const EL_tr = div.currentTarget.closest("tr").querySelectorAll(":not(.priority)");
    // var EL_tr = div.currentTarget.closest("tr").querySelector(`[name=toDo]`);
    // EL_tr = EL_tr + div.currentTarget.closest("tr").querySelector(`[name=dueTo]`);
